This package implements an extended, more consistent and TypeScript-driven implementation of [`fantasywind/redux-middleware-fetch`](https://github.com/fantasywind/redux-middleware-fetch) ([docs](#redux-middleware-fetch)).

The package structure was completely changed and is now based on [`alexjoverm/typescript-library-starter`](https://github.com/alexjoverm/typescript-library-starter) ([docs](#typescript-library-starter)).
