...
exports.default = function () { return function (next) { return function (action) { return __awaiter(_this, void 0, void 0, function () {
    var requestOptions, entrypoint, types, auth, json, body, formData, method, onSuccess, onFailed, urlEncoded, fqdn, headers, dispatchPayload, customHeaders, successType, errorType, requestType, fetchOptions, token, response, responseJson, url, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                ...
                if (errorType) {
                    next(__assign({}, dispatchPayload, { error: error_1, response: response, type: errorType }));
                }
