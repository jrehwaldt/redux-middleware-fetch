...
exports.default = function () { return function (next) { return function (action) { return __awaiter(_this, void 0, void 0, function () {
    var requestOptions, entrypoint, types, auth, json, body, formData, method, onSuccess, onFailed, urlEncoded, fqdn, headers, dispatchPayload, customHeaders, successType, errorType, requestType, fetchOptions, token, response, responseJson, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
                ...
                if (auth) {
                    ...
                    if (token) {
                        ...
                        return [2 /*return*/, next({
                                type: exports.API_NO_TOKEN_STORED
                            })];
                    }
                }
                // ContentType
            ...
            case 1:
                ...
                next({
                    type: exports.API_REQUEST_START
                });
                return [4 /*yield*/, fetch("" + (fqdn || storage.getItem("host") || "/api") + entrypoint, fetchOptions)];
            case 2:
                response = _a.sent();
                // Request Animation End
                next({
                    type: exports.API_REQUEST_END
                });
            ...
            case 7:
                ...
                return [2 /*return*/, next(__assign({}, dispatchPayload, { error: response.message, payload: responseJson, response: response, type: errorType }))];
            ...
            case 9:
                ...
                if (errorType) {
                    next(__assign({}, dispatchPayload, { error: error_1, type: errorType }));
                }
            ...
            case 10:
                ...
                return [2 /*return*/, next(__assign({}, dispatchPayload, { payload: responseJson, response: response, type: successType }))];
        }
    });
}); }; }; };
