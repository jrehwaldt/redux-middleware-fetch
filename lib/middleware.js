...
exports.default = function () { return function (next) { return function (action) { return __awaiter(_this, void 0, void 0, function () {
    var requestOptions, entrypoint, types, auth, json, body, formData, method, onSuccess, onFailed, urlEncoded, fqdn, headers, dispatchPayload, customHeaders, successType, errorType, requestType, fetchOptions, token, response, response_1, json_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                json_1 = _a.sent();
                if (onFailed) {
                    onFailed(response_1.message, json_1, response_1);
                }
                return [2 /*return*/, next(__assign({}, dispatchPayload, { error: response_1.message, payload: json_1, response: response_1, type: errorType }))];
            case 8: return [3 /*break*/, 10];
            case 9:
                error_1 = _a.sent();
                if (onFailed) {
                    onFailed(error_1.message, error_1);
                }
                if (errorType) {
            ...
            case 10:
                ...
                return [2 /*return*/, next(__assign({}, dispatchPayload, { payload: json, response: response, type: successType }))];
        }
    });
}); }; }; };
