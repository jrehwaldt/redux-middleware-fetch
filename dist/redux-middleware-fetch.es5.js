...
var API_NO_TOKEN_STORED = "REDUX_MIDDLEWARE_FETCH/API_NO_TOKEN_STORED";
var API_REQUEST_START = "REDUX_MIDDLEWARE_FETCH/API_REQUEST_START";
var API_REQUEST_END = "REDUX_MIDDLEWARE_FETCH/API_REQUEST_END";
//
...
var middleware = function (api) {
    return function (next) {
        return function fetchActionHandler(action) {
            return __awaiter(this, void 0, void 0, function () {
                var requestOptions, entrypoint, types, auth, json, body, formData, method, onSuccess, onFailed, urlEncoded, fqdn, headers, _a, uuid, dispatchPayload, customHeaders, successType, errorType, requestType, fetchOptions, token, noTokenAction, response, responseJson, url, initAction, parseFailureAction, error_1, fetchFailureAction, successAction;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (auth) {
                                ...
                                if (token) {
                                    ...
                                    noTokenAction = __assign({}, dispatchPayload, { type: API_NO_TOKEN_STORED, uuid: uuid, error: "Access token required." });
                                    next(noTokenAction);
                                    return [2 /*return*/, Promise.reject(noTokenAction)];
                                }
                            }
                            // ContentType
                            if (json) {
                        ...
                        case 1:
                            ...
                            // Before Request
                            if (requestType) {
                                initAction = __assign({}, dispatchPayload, { type: requestType, entrypoint: entrypoint,
                                    url: url,
                        ...
                        case 2:
                            response = _b.sent();
                            // Request Animation End
                            next(__assign({}, dispatchPayload, { type: API_REQUEST_END, uuid: uuid }));
                        ...
                        case 7:
                            responseJson = _b.sent();
                            parseFailureAction = __assign({}, dispatchPayload, { error: response.message, payload: responseJson, response: response, type: errorType, uuid: uuid });
                            if (onFailed) {
                            ...
                            return [2 /*return*/, Promise.reject(parseFailureAction)];
                        case 8: return [3 /*break*/, 10];
                        case 9:
                            error_1 = _b.sent();
                            fetchFailureAction = __assign({}, dispatchPayload, { error: error_1,
                            ...
                            return [2 /*return*/, Promise.reject(fetchFailureAction)];
                        case 10:
                            successAction = __assign({}, dispatchPayload, { payload: responseJson, response: response, type: successType, uuid: uuid });
                            if (onSuccess) {
                                onSuccess(successAction);
                            }
                            next(successAction);
                            return [2 /*return*/, Promise.resolve(successAction)];
                    }
                });
            });
        };
...
export { API_REQUEST, API_NO_TOKEN_STORED, API_REQUEST_START, API_REQUEST_END, setAPIHost, setToken, setStorage, middleware };export default middleware;
//# sourceMappingURL=redux-middleware-fetch.es5.js.map
